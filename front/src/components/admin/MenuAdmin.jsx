...
export default function MenuAdmin({ tipo, nombre, Foto }) {
                ...
                >
                    ...
                    <List>
                        <RouterLink to="/usuarios">
                            ...
                            >
                                <ListItemIcon>
                                    <PeopleAltnIcon className={classes.iconcolor} />
                                </ListItemIcon>
                                <ListItemText primary="Usuarios" className={classes.color}> </ListItemText>
                            </ListItem>
                        </RouterLink>
